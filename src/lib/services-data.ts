...
export const SERVICES: Record<ServiceKey, Record<Lang, ServiceContent>> = {
  ...
  "water-damage": {
    fr: {
      ...
      eyebrow: "Dégât d'eau",
      intro:
        "Téléphone tombé dans l'eau, la toilette ou la piscine ? Le temps joue contre vous : la corrosion commence en quelques heures. Éteignez l'appareil, n'essayez pas de le charger, et apportez-le rapidement. On le confie à notre partenaire spécialisé en récupération après dégât d'eau, et on vous dit franchement s'il vaut la peine d'être sauvé.",
      ...
      bullets: [
        ...
        "Envoi à notre partenaire spécialisé pour ouverture, nettoyage et évaluation",
        "Micro-soudure et récupération de données selon le cas",
      ...
      faq: [
        ...
        { q: "Le diagnostic est-il gratuit ?", a: "Pas pour un dégât d'eau. L'appareil doit être ouvert par notre partenaire spécialisé pour évaluer les dommages, donc des frais de diagnostic s'appliquent. On vous en informe avant l'envoi." },
        ...
        { q: "Combien de temps ça prend ?", a: "Comptez quelques jours : l'appareil est envoyé à notre partenaire spécialisé, évalué, puis traité si la récupération en vaut la peine. On vous tient au courant à chaque étape." },
    ...
    en: {
      ...
      intro:
        "Phone in the sink, the toilet or the pool? Time is working against you — corrosion starts within hours. Turn the device off, don't try to charge it, and bring it in fast. We send it to our specialized water-damage recovery partner, and we tell you honestly whether it's worth saving.",
      ...
      bullets: [
        ...
        "Sent to our specialized partner for opening, cleaning and assessment",
        "Micro-soldering and data recovery where the damage allows it",
      ...
      faq: [
        ...
        { q: "Is the diagnostic free?", a: "Not for water damage. The device has to be opened by our specialized partner to assess the damage, so a diagnostic fee applies. We tell you before anything is sent." },
        ...
        { q: "How long does it take?", a: "Count on a few days: the device is sent to our specialized partner, assessed, then treated if recovery is worth it. We keep you posted at every step." },
